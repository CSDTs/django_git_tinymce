          ...
          <div class="panel panel-success">
            ...
            <table class="table">
              ...
              {this.props.files.files.map((file) => {
                ...
                const renameLink = (files.is_owner) ? (file.type == 'blob') ? <a href={`/${window.props.repo_owner}/${window.props.repo_name}/${(window.props.directory !== '') ? `${window.props.directory}/` : ``}blob/${file.name}/rename`} style={{fontSize: '.75em', color: '#999'}}>rename</a>: null : null
