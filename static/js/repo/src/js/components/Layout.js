      ...
      <div className="row">
        <div className="col-md-6 col-xs-8">
          <p>
            ...
            {(window.props.is_fork) ? <div><br/><font className="small-fork-text">Forked from <a href={`/${window.props.fork_owner}/${window.props.fork_name}/`}>{`${window.props.fork_owner}/${window.props.fork_name}`}</a></font></div> : null }
          </p>
        </div>
